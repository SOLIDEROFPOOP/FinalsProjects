...
import com.muratkapparov.springbootlibrary.RequestModels.ReviewRequest;
import com.muratkapparov.springbootlibrary.service.BookService;
import com.muratkapparov.springbootlibrary.service.ReviewService;
...
public class ReviewController {
    ...
    public Boolean reviewBookByUser(@RequestHeader(value = "Authorization") String token, @RequestParam Long bookId) throws Exception{
        String userEmail = ExtractJWT.payloadJWTExtraction(token, "\"sub\"");
        if (userEmail == null){
            throw new Exception("User email is missing dalbaeb");
        }
