                    ...
                    <div className="col-4 col-md-4 container d-flex justify-content-center align-items-center">
                        <div className="ml-2">
                            ...
                            <p className="lead">
                                ...
                                We will provide the top content for you!
                            </p>
                    ...
                    <div className="col-4 col-md-4 container d-flex justify-content-center align-items-center">
                            <div className="ml-2">
                                ...
                                <p className="lead">
                                    ...
                                    for our love 2 read students! We are dilligent about our book selection
                ...
                <div className="container">
                    <div className="m-2">
                        ...
                        <h1>What have you been reading?</h1>
                            ...
                            {authState?.isAuthenticated?
                            <Link type="button" className="btn main-color btn-lg text-whtie" to="search">Explore top books</Link>   
                            :
                            <Link className="btn main-color btn-lg text-white" to="/login">Sign up</Link>
                        }
                        </div>
